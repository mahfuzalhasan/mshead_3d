...
parser.add_argument('--trained_weights', default='/orange/r.forghani/results/03-17-24_1410/model_best.pth', required=False, help='Path of pretrained/fine-tuned weights')
