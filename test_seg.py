...
parser.add_argument('--trained_weights', default='/orange/r.forghani/results/07-22-24_1719/model_best.pth', required=False, help='Path of pretrained/fine-tuned weights')
