...
if args.dataset != 'amos':
    if args.fold == 0:
        args.trained_weights = '/orange/r.forghani/results/12-20-24_0342/model_best.pth'
        ...
        args.trained_weights = '/orange/r.forghani/results/12-20-24_1658/model_best.pth'
        ...
        args.trained_weights = '/orange/r.forghani/results/12-20-24_1836/model_best.pth'
        ...
        args.trained_weights = '/orange/r.forghani/results/12-20-24_1943/model_best.pth'
        ...
        args.trained_weights = '/orange/r.forghani/results/12-21-24_0006/model_best.pth'
