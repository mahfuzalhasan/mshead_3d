...
parser.add_argument('--trained_weights', default='/orange/r.forghani/results/03-12-24_1645/model_best.pth', required=False, help='Path of pretrained/fine-tuned weights')
