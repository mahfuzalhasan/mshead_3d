...
def organ_class_dict_selection(dataset):
    if dataset =='amos':
        ORGAN_CLASSES = {
            1: "Spleen",
            2: "Right Kidney",
...
def prediction_organ_wise(dataset, pred_dir, gt_dir):
    # Model Prediction and Ground Truth Directories
    print(f'Prediction Directory: {pred_dir}')
    print(f'Ground Truth Directory: {gt_dir}')
    
    ORGAN_CLASSES = organ_class_dict_selection(dataset)
...
if __name__=="__main__":
    ...
    prediction_organ_wise('amos', pred_dir, gt_dir)
