...
def process_sample(item, transforms, out_dir):
    ...
    img_out_path = os.path.join(case_out_dir, "imaging.pt")
    lbl_out_path = os.path.join(case_out_dir, "segmentation.pt")
    ...
    torch.save(img_tensor, img_out_path)
    torch.save(lbl_tensor, lbl_out_path)
