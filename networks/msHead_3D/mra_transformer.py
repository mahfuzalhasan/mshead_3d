...
class MRATransformer(nn.Module):
    def __init__(self, img_size=(96, 96, 96), patch_size=2, in_chans=1, num_classes=5, embed_dims=[48, 96, 192, 384], 
                 num_heads=[3, 6, 12, 24], mlp_ratios=[4, 4, 4, 4], local_region_scales = [2, 2, 1, 1], 
        ...
        self.block1 = nn.ModuleList([Block(
            ...
            n_local_region_scale=local_region_scales[0], dwt_layer_1=True, img_size=(img_size[0]// 2, img_size[1]//2, img_size[2]//2))
        ...
        self.block2 = nn.ModuleList([Block(
            ...
            drop=drop_rate, attn_drop=attn_drop_rate, drop_path=dpr[cur + i], norm_layer=norm_layer,
            n_local_region_scale=local_region_scales[1], dwt_layer_1=True, img_size=(img_size[0]//4, img_size[1]//4, img_size[2]//4))
        ...
        self.block4 = nn.ModuleList([Block(
            ...
            drop=drop_rate, attn_drop=attn_drop_rate, drop_path=dpr[cur + i], norm_layer=norm_layer,
            n_local_region_scale=local_region_scales[3], dwt_layer_1=False, img_size=(img_size[0]//16, img_size[1]//16, img_size[2]//16))
...
class mra_b0(MRATransformer):
    def __init__(self, img_size, num_classes, embed_dims, depths, num_heads, local_region_scales, drop_path_rate):
        super(mra_b0, self).__init__(
            ...
            num_heads=num_heads, mlp_ratios=[4, 4, 4, 4], local_region_scales = local_region_scales, qkv_bias=True, 
