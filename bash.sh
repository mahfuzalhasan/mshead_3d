...
#SBATCH --output=/blue/r.forghani/mdmahfuzalhasan/project_analysis/mshead_3d/results/swin_like_feta.%J.out
#SBATCH --error=/blue/r.forghani/mdmahfuzalhasan/project_analysis/mshead_3d/results/swin_like_feta.%J.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
