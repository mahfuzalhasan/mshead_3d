...
srun python main_train.py --dataset LN --network SNET --cache_rate 1.0 --batch_size 12 --crop_sample 6 --lr 0.0005 --num_workers $SLURM_CPUS_PER_TASK
# srun python test_seg.py --dataset LN --network SNET --cache_rate 1.0 --batch_size 3 --crop_sample 4 --lr 0.0002 --num_workers $SLURM_CPUS_PER_TASK