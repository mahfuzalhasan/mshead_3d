...
#SBATCH --output=/blue/r.forghani/mdmahfuzalhasan/scripts/mshead_3d/results/feta_wavelet_max_ds_job.%J.out
#SBATCH --error=/blue/r.forghani/mdmahfuzalhasan/scripts/mshead_3d/results/feta_wavelet_max_ds_job.%J.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
