...
#SBATCH --output=/blue/r.forghani/mdmahfuzalhasan/project_analysis/mshead_3d/results/wavelet_max_ds_job.%J.out
#SBATCH --error=/blue/r.forghani/mdmahfuzalhasan/project_analysis/mshead_3d/results/wavelet_max_ds_job.%J.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
