...
if args.dataset != 'amos':
    if args.fold == 0:
        ...
        args.pretrained_weights = '/orange/r.forghani/results/11-05-24_0313/model_best.pth'
    elif args.fold == 1:
        # args.trained_weights = '/orange/r.forghani/results/09-20-24_0448/model_best.pth'
        args.pretrained_weights = '/orange/r.forghani/results/11-05-24_0319/model_best.pth'
    elif args.fold == 2:
        # args.trained_weights = '/orange/r.forghani/results/09-21-24_1416/model_best.pth'
        args.pretrained_weights = '/orange/r.forghani/results/11-05-24_0325/model_best.pth'
    elif args.fold == 3:
        # args.trained_weights = '/orange/r.forghani/results/09-18-24_2221/model_best.pth'
        args.pretrained_weights = '/orange/r.forghani/results/11-05-24_0334/model_best.pth'
    elif args.fold == 4:
        # args.trained_weights = '/orange/r.forghani/results/09-18-24_2224/model_best.pth'
        args.pretrained_weights = '/orange/r.forghani/results/11-05-24_0340/model_best.pth'
