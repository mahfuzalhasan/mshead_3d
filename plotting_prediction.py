...
if args.dataset != 'amos':
    if args.fold == 0:
        args.trained_weights = '/orange/r.forghani/results/02-14-25_0434/model_best.pth'        # flare hf ref b.up gate fusion
        ...
        args.trained_weights = '/orange/r.forghani/results/02-14-25_0444/model_best.pth'        # flare hf ref b.up gate fusion
        ...
        args.trained_weights = '/orange/r.forghani/results/02-14-25_0519/model_best.pth'        # flare hf ref b.up gate fusion
        ...
        args.trained_weights = '/orange/r.forghani/results/02-14-25_0539/model_best.pth'        # flare hf ref b.up gate fusion
        ...
        args.trained_weights = '/orange/r.forghani/results/02-14-25_0552/model_best.pth'        # flare hf ref b.up gate fusion
