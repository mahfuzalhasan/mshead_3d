...
if args.dataset != 'amos':
    if args.fold == 0:
        args.trained_weights = '/orange/r.forghani/results/02-04-25_0044/model_best.pth'    #flare_hf_fusion
        # args.trained_weights = '/orange/r.forghani/results/01-28-25_0027/model_best.pth'    #flare_hf_Agg
        ...
        args.trained_weights = '/orange/r.forghani/results/02-06-25_1619/model_best.pth'    #flare_hf_fusion
        # args.trained_weights = '/orange/r.forghani/results/01-28-25_0048/model_best.pth'    #flare_hf_Agg
        ...
        args.trained_weights = '/orange/r.forghani/results/02-07-25_0113/model_best.pth'   #flare_hf_fusion
        # args.trained_weights = '/orange/r.forghani/results/01-28-25_2240/model_best.pth'    #flare_hf_Agg
        ...
        args.trained_weights = '/orange/r.forghani/results/02-08-25_0234/model_best.pth'    #flare_hf_fusion
        # args.trained_weights = '/orange/r.forghani/results/01-28-25_2322/model_best.pth'    #flare_hf_Agg
        ...
        args.trained_weights = '/orange/r.forghani/results/02-08-25_0240/model_best.pth'    #flare_hf_fusion
        # args.trained_weights = '/orange/r.forghani/results/01-29-25_1409/model_best.pth'    #flare_hf_Agg
