...
if args.dataset == 'flare':
    if args.network == 'MSHEAD':
        ...
        model_id_dict = {0:"02-19-25_2216", 1:"02-19-25_2312", 2:"02-20-25_0032", 3:"", 4:""} # flare simple ref_sp_hf layers residual up
...
if args.network=='MSHEAD':
    ...
    pred_dir = f'/orange/r.forghani/results/kits23/{args.network}/{model_id}/output_seg'
...
for label in os.listdir(pred_dir):
    ...
    label_gt = os.path.join(gt_dir, label.replace("_imaging", "_segmentation") + ".nii.gz")
