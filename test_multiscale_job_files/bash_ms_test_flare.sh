#!/bin/bash
#SBATCH --job-name=multiscale_flare_wf_2211
#SBATCH --output=/blue/r.forghani/mdmahfuzalhasan/ablation_studies/ablation_flare/wavelet-two-branch/mshead_3d/results/wf_2211_flare_ms_test_job.%J.out
#SBATCH --error=/blue/r.forghani/mdmahfuzalhasan/ablation_studies/ablation_flare/wavelet-two-branch/mshead_3d/results/wf_2211_flare_ms_test_job.%J.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
