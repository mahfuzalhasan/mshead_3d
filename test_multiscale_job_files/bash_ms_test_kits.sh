#!/bin/bash
#SBATCH --job-name=multiscale_kits_wf_3211
#SBATCH --output=/blue/r.forghani/mdmahfuzalhasan/ablation_studies/ablation_kits/wf_3211/mshead_3d/results/wf_3211_kits_ms_test_job.%J.out
#SBATCH --error=/blue/r.forghani/mdmahfuzalhasan/ablation_studies/ablation_kits/wf_3211/mshead_3d/results/wf_3211_kits_ms_test_job.%J.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
